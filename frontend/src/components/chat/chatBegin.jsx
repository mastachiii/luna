...
export default function ChatBegin({ friendData }) {
    return (
        <div className="flex flex-col gap-1 ml-6 mt-5 mb-6 dark:text-zinc-100">
            ...
            <p className="mt-4 text-sm text-zinc-700 font-light dark:text-zinc-300">This is the beginning of your conversation with {friendData.displayName}</p>
        </div>
    );
}
